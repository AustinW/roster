    ...
    <b-form @submit="onSubmit" @reset="onReset">
        <b-form-row>
            ...
            <b-form-group label="Last Name" label-for="last_name" class="col-md-6">
                <b-form-input id="last_name" v-model="last_name" required placeholder="Last Name"></b-form-input>
            </b-form-group>
        </b-form-row>

        <b-form-row>
            <b-form-group label="USAG Number" label-for="usag_id" class="col-md-6">
                <b-form-input id="usag_id" v-model="usag_id" required placeholder="USAG Number"></b-form-input>
            </b-form-group>
        ...
        <b-form-row>
            <b-form-group label="Birthdate" label-for="birthdate" class="col-md-12">
                <b-form-input id="birthdate" v-model="birthdate" required placeholder="mm/dd/yyyy"></b-form-input>
            </b-form-group>
        </b-form-row>

        <b-form-row>
            <b-form-group label="Trampoline" label-for="tra_level" class="col-md-4">
                <b-form-select id="tra_level" v-model="tra_level" :options="allLevels" required placeholder="Trampoline Level"></b-form-select>
            </b-form-group>
            <b-form-group label="Double Mini" label-for="dmt_level" class="col-md-4">
                <b-form-select id="dmt_level" v-model="dmt_level" :options="allLevels" required placeholder="Double Mini Level"></b-form-select>
            </b-form-group>
            <b-form-group label="Tumbling" label-for="tum_level" class="col-md-4">
                <b-form-select id="tum_level" v-model="tum_level" :options="allLevels" required placeholder="Tumbling Level"></b-form-select>
            </b-form-group>
        </b-form-row>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      allLevels() {
        let allLevels = this.$store.getters.allLevels

        allLevels.map((level) => {
          Object.defineProperty(level, 'text', Object.getOwnPropertyDescriptor(level, 'value'))
          delete level['value']

          Object.defineProperty(level, 'value', Object.getOwnPropertyDescriptor(level, 'key'))
          delete level['key']
        })
